...
from model import *
from datasets import CIFAR10_truncated, CIFAR100_truncated, ImageFolder_custom, FashionMNIST_truncated, EMNIST_truncated
...
def load_emnist_data(datadir):
    ...
    emnist_train_ds = EMNIST_truncated(datadir, train=True, download=True, transform=transform)   # balanced 已在类里固定
...
def get_dataloader(dataset, datadir, train_bs, test_bs, dataidxs=None, noise_level=0):
    if dataset in ('cifar10', 'cifar100'):
        ...
        dl_obj = EMNIST_truncated  # balanced 已在类里固定
